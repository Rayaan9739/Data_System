    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-white/95 backdrop-blur-md shadow-md">
      ...
      {isOpen && (
        <div className="md:hidden bg-white shadow-md border-t border-gray-200">
          ...
          <button
            onClick={() => { onNavigate("staff"); setIsOpen(false); }}
            className="block w-full text-left px-6 py-3 hover:bg-blue-50 transition font-medium"
          >
            Staff Form
          </button>
          <button
            ...
            className="block w-full text-left px-6 py-3 border-t border-gray-200 rounded-b-lg text-blue-500 hover:bg-blue-500 hover:text-white transition font-medium"
          >
            Logout
          </button>
        </div>
